...
- Are you a new teacher? Take a look [here](https://github.com/FooCoding/curriculum/blob/master/i-am-a-new-teacher.md) for some practical tips on how to get started!
- Are you a new student? Take a look [here](https://github.com/FooCoding/curriculum/blob/master/i-am-a-new-student.md) to see how to prepare for your first class!

### **Are you either a new student or a new teacher? Take a look at what we see as our [core values](https://github.com/FooCoding/curriculum/blob/master/hyf-core-values.md) at HackYourFuture before you join our community** :heart:

# What do we teach?

## [HTML/CSS](https://github.com/FooCoding/HTML-CSS)/[CLI](https://github.com/FooCoding/CommandLine/)
...
## [Node](https://github.com/FooCoding/Node.js)
...
## [Database](https://github.com/FooCoding/databases)
...
## [React](https://github.com/FooCoding/React)
...
## [Project](https://github.com/FooCoding/Project)
